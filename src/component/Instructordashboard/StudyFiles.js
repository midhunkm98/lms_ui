...
import InstructorSidebar from '../Sidebar/InstructorSidebar'; // Adjust the path if necessary
...
const UploadedFilesList = () => {
    ...
    const handleDownload = (filePath) => {
        ...
        link.href = filePath;
        link.download = filePath.split('/').pop(); // This will extract the filename from the URL
        link.click();
    };
                ...
                <table className="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Uploaded Date</th>
                            {/* <th>File</th> */}
                            <th>Actions</th> {/* Add an Actions column for the Download button */}
                        </tr>
                    </thead>
                    <tbody>
